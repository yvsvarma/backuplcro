...
public class MLRunCalculationConsumer {
	...
	public ResultObject runCalculation(String appName, String POV,boolean isClearCalculated, 
			boolean isExecuteCalculations, boolean isRunNow, String subsetStart, String subsetEnd, 
			String ruleName, String ruleSetName, String exeType) throws ParseException{
	...
	public static void main(String[] args)  {
		...
		try {
			ResultObject results =WSObj.runCalculation("RLM2", "2014_January_Actual", false , false , false, "", "", "","", "ALL_RULES");
