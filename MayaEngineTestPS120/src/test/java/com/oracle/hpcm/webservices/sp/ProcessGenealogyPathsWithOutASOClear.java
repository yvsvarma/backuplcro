 ...
 */
public class ProcessGenealogyPathsWithOutASOClear{
	private String url;
	...
	public ProcessGenealogyPathsWithOutASOClear() {
	...
	public ResultObject runGenCalcWithOutASOClear(String appName, String Pov, LayerName layerName, String paths) throws ParseException{
		HashMap<String, String> hashMap = new HashMap<String, String>();
		hashMap.put("layerName", layerName.toString());
		hashMap.put("paths", paths);
		String runGenURL = url + appName + "/povs/"+ Pov + "/jobs/geneologyExecutionPathWithoutASOCubeClearProcessJob";
	...
	public static void main(String[] args) {
		...
		try {
			System.out
					.println("status: "
							+ WSObj.runGenCalcWithOutASOClear("BksSP82","2009_January_Actual",LayerName.COST,"1-2-3;3-4").getText());
