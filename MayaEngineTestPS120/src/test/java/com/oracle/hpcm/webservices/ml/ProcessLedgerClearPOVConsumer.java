...
public class ProcessLedgerClearPOVConsumer {
	...
	public ResultObject clearPOV(String appName, String pov, boolean  manageRule,boolean inputData, boolean adjustmentValues, boolean allocatedValues) throws ParseException{
	...
	public static void main(String[] args) {
		...
		try {
			ResultObject result = WSObj.clearPOV("RLM1","2013_January_Actual", false,true,false,false);
			System.out
					.println("status: "
							+ result.isResult() );
