...
public class PropertiesUtils {
	...
	public static void processGlobalProperties(Properties systemPoroperties) {
		...
		if(staging != null){
			...
			if (propValueFromCommandLine == null
             ...
             public static String getEpmAutomateUrl(){
		
		String staging = System.getProperty("staging");
		String url;
		if(staging.equalsIgnoreCase("false")){
			url = String.format("http://%s:%s", System.getProperty("server"),System.getProperty("port"));
		}else{
			url = String.format("https://%s", System.getProperty("server"));		
                }
		return url;
	} 
	...
	public static UserObject getUserObject(){
        ...
        public static UserObject getUserObject(String userName, String password){
		String staging = System.getProperty("staging");
		UserObject user;
		if(staging.equalsIgnoreCase("false")){
			user = new UserObject(userName,password,System.getProperty("domain"),false);
		}else{
			user = new UserObject(userName,password,System.getProperty("domain"),true);
		}
		return user;
	}
