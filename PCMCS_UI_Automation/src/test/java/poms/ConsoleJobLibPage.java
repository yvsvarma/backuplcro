...
import static tests.BaseTestSuite.logit;
...
public class ConsoleJobLibPage {
	...
	By jobRows = By.xpath(".//table[@summary='Job Library Data']/tbody/tr[1]//td[3]");
...
/*		filterByJobType(jobType);
	...
	public boolean isFirstJobListedIsSuccess() throws Exception{
		...
		logit("Status of the job is : "+listOfElements.get(0).getText());
