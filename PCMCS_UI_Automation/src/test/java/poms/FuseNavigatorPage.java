...
public class FuseNavigatorPage {
    ...
    By dataloadLink = By.xpath(".//a[@id='f2:0:sdi2::disAcr' and contains (text(),'Data Load')]");
    //By dataloadLink = By.xpath(".//span[contains(.,'Data Load')]");
    By manageCalculationLink = By.xpath("(.//span[text()='Calculation']/..)");//need to remove the index
    ...
    public POVManagerPage navigateToPovManager() {
        clickNavigateButton();
        driver.findElement(povManagerLink).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//h1[contains(text(),'Points of View')]")));
        return new POVManagerPage(driver);
    }
    public ModelValidationPage navigateToModelValidationPage(){
		clickNavigateButton();
		driver.findElement(this.modelValidationLink).click();
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//h1[contains(text(),'Model Validation')]")));
		return new ModelValidationPage(driver);
	}
    public DashboardPage navigateToDashboards() {
        clickNavigateButton();
        driver.findElement(dashboardLink).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//span[contains(text(),'Dashboards')]")));
        return new DashboardPage(driver);
    }

    public FRPage navigateToReports() {
        clickNavigateButton();
        driver.findElement(reportsLink).click();
        //validations needs to be removed.
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//span[contains(text(),'Financial Reports')]")));
        return new FRPage(driver);
    }

    public SystemReportPage navigateToSystemReports() {
        clickNavigateButton();
        driver.findElement(sysReportsLink).click();
        //validations needs to be removed.
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//h1[contains(text(),'System Reports')]")));
        return new SystemReportPage(driver);
    }

    public ManageCalcPage navigateToManageCalculation() {
        clickNavigateButton();
        driver.findElement(manageCalculationLink).click();
        //validations needs to be removed.
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//h1[contains(text(),'Calculation')]")));
        return new ManageCalcPage(driver);
    }

    public RuleBalancingPage navigateToRuleBalancing() {
        clickNavigateButton();
        driver.findElement(ruleBalancingLink).click();
        //validations needs to be removed.
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//h1[contains(text(),'Rule Balancing')]")));
        return new RuleBalancingPage(driver);
    }

    public ManageRulesPage navigateToManageRules() {
        clickNavigateButton();
        driver.findElement(manageRulesLink).click();
        //validations needs to be removed.
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//h1[contains(text(),'Rules')]")));
        return new ManageRulesPage(driver);
    }

    public ManageModelViewsPage navigateToModelViews() {
        clickNavigateButton();
        driver.findElement(modelViewLink).click();
        //validations needs to be removed.
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//h1[contains(text(),'Manage Model Views')]")));
        return new ManageModelViewsPage(driver);
    }

    public ManageDBPage navigateToManageDB() {
        clickNavigateButton();
        ...
        return new ManageDBPage(driver);
    }
    ...
    public ManageQueriesPage navigateToManageQueries() {
        clickNavigateButton();
        driver.findElement(manageQueriesLink).click();
        //validations needs to be removed.
        return new ManageQueriesPage(driver);
    }
    ...
    public IntelligencePage navigateToIntelligence() throws InterruptedException {

        clickNavigateButton();
        driver.findElement(intelligenceLink).click();
        BasicUtil.waitADF(driver, 100);
        //validations needs to be removed.
        //wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//span[contains(text(),'Analysis')]")));
        return new IntelligencePage(driver);
    }
