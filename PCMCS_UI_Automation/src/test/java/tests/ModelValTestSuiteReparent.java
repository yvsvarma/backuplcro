...
public class ModelValTestSuiteReparent extends BaseTestSuite {
	...
	public void uploadDimensionFileReparent() throws Exception {
		log("Load dimension to the application.");
		ml_application = "BksML30";
		UserObject uo = restClient.getUserObject();
		EPMAutomateUtility.uploadFileOverwrite(uo, "../testdata/files", "Account_Reparented.txt", "profitinbox");

		Assert.assertTrue(restClient.uploadDimension(ml_application, "Account_Reparented.txt"), "Update dimension failed for reparened account.txt");
		Assert.assertTrue( restClient.deployCube(ml_application, true, false, true, ""),"Deploy cube job failed.");
	}

	@Test(priority = 7, enabled = true)
	public void getMVforAnalyticsReparentMember() throws IOException, Exception {
		String actualFilePath = "./target/Analytics_Reparent.txt";
		String expectedFilePath = "../testdata/files/Analytics_Reparent.txt";
	...
	public void getMVforDGReparentMember() throws IOException, Exception {
		SoftAssert assertions = new SoftAssert();
		String actualFilePath = "./target/DataGrants_Reparent.txt";
		String expectedFilePath = "../testdata/files/DataGrants_Reparent.txt";
	...
	public void getMVforQueriesReparentMember() throws IOException, Exception {
		SoftAssert assertions = new SoftAssert();
		String actualFilePath = "./target/Queries_Reparent.txt";
		String expectedFilePath = "../testdata/files/Queries_Reparent.txt";
	...
	public void getMVforModelViewReparentMember() throws IOException, Exception {
		SoftAssert assertions = new SoftAssert();
		String actualFilePath = "./target/ModelViews_Reparent.txt";
		String expectedFilePath = "../testdata/files/ModelViews_Reparent.txt";
	...
	public void getMVforRulesReparentMember() throws IOException, Exception {
		SoftAssert assertions = new SoftAssert();
		String actualFilePath = "./target/Rules_Reparent.txt";
		String expectedFilePath = "../testdata/files/Rules_Reparent.txt";
