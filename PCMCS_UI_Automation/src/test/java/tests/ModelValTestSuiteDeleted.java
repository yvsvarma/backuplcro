...
public class ModelValTestSuiteDeleted extends BaseTestSuite {
    ...
    public void loginTest() throws Exception 
    {
        ...
        log("Login successful.");
        mvpage = navPage.navigateToModelValidationPage();
        log("Moved to the Model Validation Page");
    }

  
    @Test(priority = 3, enabled = true)
    public void uploadDimensionFile() throws Exception 
    {
        log("Load dimension to the application.");
        UserObject uo = restClient.getUserObject();
        EPMAutomateUtility.uploadFileOverwrite(uo, "../testdata/files", "Account_Delete.txt", "profitinbox");
        Assert.assertTrue(restClient.uploadDimension(ml_application, "Account_Delete.txt"), "Update dimension failed for Account_mv.txt");
        Assert.assertTrue( restClient.deployCube(ml_application, true, false, true, ""),"Deploy cube job failed.");
    }

    @Test(priority = 7, enabled = true)
    public void getMVforAnalyticsDeleteMember() throws IOException, Exception 
    {
        String actualFilePath = "./target/Analytics_Delete.txt";
        String expectedFilePath = "../testdata/files/Analytics_Delete.txt";
    ...
    public void getMVforDGDeleteMember() throws IOException, Exception {
        SoftAssert assertions = new SoftAssert();
        String actualFilePath = "./target/DataGrants_Delete.txt";
        String expectedFilePath = "../testdata/files/DataGrants_Delete.txt";
    ...
    public void getMVforQueriesDeleteMember() throws IOException, Exception {
        SoftAssert assertions = new SoftAssert();
        String actualFilePath = "./target/Queries_Delete.txt";
        String expectedFilePath = "../testdata/files/Queries_Delete.txt";
    ...
    public void getMVforModelViewDeleteMember() throws IOException, Exception {
        SoftAssert assertions = new SoftAssert();
        String actualFilePath = "./target/ModelViews_Delete.txt";
        String expectedFilePath = "../testdata/files/ModelViews_Delete.txt";
    ...
    public void getMVforRulesDeleteMember() throws IOException, Exception {
        SoftAssert assertions = new SoftAssert();
        String actualFilePath = "./target/Rules_Delete.txt";
        String expectedFilePath = "../testdata/files/Rules_Delete.txt";
