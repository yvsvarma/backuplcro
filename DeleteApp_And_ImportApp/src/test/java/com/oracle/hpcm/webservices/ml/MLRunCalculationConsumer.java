...
public class MLRunCalculationConsumer {
	 ...
	 */
	public ResultObject runCalculation(String appName, String dataPOV,boolean isClearCalculated, boolean isExecuteCalculations, boolean isRunNow, String subsetStart, String subsetEnd, String ruleName, String ruleSetName, String exeType,String modelPOV, String stringDelimiter) throws ParseException{
		String urlRunCalc = url + appName+ "/povs/" + modelPOV + "/jobs/runLedgerCalculationJob";
                logger.info(urlRunCalc);
		...
		hsMap.put("exeType", exeType);
                hsMap.put("dataPOVName", dataPOV);
		hsMap.put("stringDelimiter", stringDelimiter);
                hsMap.put("optimizeReporting", "false");
	...
	public static void main(String[] args)  {
		...
		try {
			ResultObject results =WSObj.runCalculation("RBML12", "2014_January_Actual", false , true , true, "", "", "","", "ALL_RULES","2014_January_Actual","_");
