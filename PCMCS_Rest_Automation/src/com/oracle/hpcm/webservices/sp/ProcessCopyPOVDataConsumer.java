 ...
 */
public class ProcessCopyPOVDataConsumer {
	private String url;
	private String password;
	private String user;
	private String response;
	public static Logger logger = Logger.getLogger("copyPov");
	public ProcessCopyPOVDataConsumer() {
	...
	public ResultObject copyPOV(String appName, String srcPov,String destPov, boolean  copyCostLayerData
			,boolean copyRevenueLayerData, boolean copyAssignments, boolean copyDriverAssociations,
			boolean copyDriverValues, boolean copyCostRevenueValues, boolean copyCalculationRules) throws ParseException{
		HashMap<String, String> hashMap = new HashMap<String, String>();
		hashMap.put("copyCostLayerData", ""+copyCostLayerData);
		hashMap.put("copyRevenueLayerData", ""+copyRevenueLayerData);
		hashMap.put("copyAssignments", ""+copyAssignments);
		hashMap.put("copyDriverAssociations", ""+copyDriverAssociations);
		hashMap.put("copyDriverValues", ""+copyDriverValues);
		hashMap.put("copyCostRevenueValues", ""+copyCostRevenueValues);
		hashMap.put("copyCalculationRules", ""+copyCalculationRules);
		String copyPovURL = url + appName + "/povs/"+ srcPov + "/jobs/copySpDpPOVJob/"+destPov;
	...
	public static void main(String[] args) {
		...
		System.setProperty("server", "slc05wjz.us.oracle.com");
		...
		try {
			System.out
					.println("status: "
							+ WSObj.copyPOV("BksSP82","2011_January_Actual","2009_January_Actual", true,true,true,true, true, true, false).getText());
