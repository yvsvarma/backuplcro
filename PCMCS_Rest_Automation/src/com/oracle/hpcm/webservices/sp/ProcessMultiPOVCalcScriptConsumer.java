 ...
 */
public class ProcessMultiPOVCalcScriptConsumer
{
	private String url;
	...
	public ProcessMultiPOVCalcScriptConsumer() {
	...
	public ResultObject runMultiPovSPCalcJob(String appName, String startPov,String endPov, LayerName layerName, boolean clearCalculatedData,boolean saveScripts) throws ParseException{
		HashMap<String, String> hashMap = new HashMap<String, String>();
		hashMap.put("layerName", layerName.toString());
		hashMap.put("clearCalculatedData", ""+clearCalculatedData);
		hashMap.put("saveScripts", ""+saveScripts);
		String runMultiPovCalcURL = url + appName + "/povs/"+startPov+"/jobs/multiPovCalcScriptProcessJob/"+endPov;
		this.response = JAXRestClient.callPostService(runMultiPovCalcURL, user, password, hashMap);
		logger.info("Run multi pov URL : "+runMultiPovCalcURL);
	...
	public static void main(String[] args) {
		...
		try {
			System.out
					.println("status: "
							+ WSObj.runMultiPovSPCalcJob("SP","2009_January_Actual","2012_January_Actual",LayerName.COST,true,false));
