...
public class CustomEmailableReporter extends EmailableReporter2  {
    private static final Logger LOG = Logger.getLogger(CustomEmailableReporter.class);
	...
	protected void writeHead() {
        writer.print("<head>");
        writer.print("<title>TestNG Report for Rest Automation</title>");
        writeStylesheet();
        writer.print("</head>");
    }
...
//    	File cssFile = new File("./conf/report.css");
//    	String csstext = null;
//    	if(cssFile.exists()){
//			try{
...
//    	if(csstext == null ){
	        ...
	        writer.print("table {width:70%;horizontal-align:center;margin-bottom:10px;padding-bottom: 50px;border-collapse:collapse;empty-cells:show}");
	        writer.print("th,td {border:2px solid #009;padding:.25em .5em}");
	        writer.print("th {vertical-align:bottom}");
	        writer.print("td {font-family: verdana, Times, serif;vertical-align:top}");
	        writer.print("table a {font-weight:bold}");
	        writer.print(".stripe td {background-color: #E6EBF9}");
	        writer.print(".num {text-align:right}");
	        writer.print(".passedodd td {background-color: #5DDA70}");
	        writer.print(".passedeven td {background-color: #5DDA70}");
	        writer.print(".skippedodd td {background-color: #E2DEDD}");
	        writer.print(".skippedeven td {background-color: #E2DEDD}");
	        writer.print(".failedodd td,.attn {background-color: #FA8A6E}");
	        writer.print(".failedeven td,.stripe .attn {background-color: #FA8A6E}");
...
//    	}
	...
	protected void writeSuiteSummary() {
        ...
        writer.print("<h1>Test Summary</h1>");
        writer.print("<table>");
        writer.print("<tr>");
	...
	protected void writeScenarioSummary() {
    	writer.print("</br>");
    	writer.print("<h1>Detailed Test Report</h1>");
        writer.print("<table>");
        writer.print("<thead>");
        writer.print("<tr>");
        ...
        if (!classResults.isEmpty()) {
            ...
            for (ClassResult classResult : classResults) {
                ...
                for (MethodResult methodResult : classResult.getMethodResults()) {
                    ...
                    String descMethod = " ";
                    if(firstResult.getMethod().getDescription()!=null)
                    	descMethod = Utils.escapeHtml(firstResult
                    ...
                    buffer.append("<td><a href=\"#m").append(scenarioIndex)
                            ...
                            .append(resultsCount).append("\">").append(descMethod)
